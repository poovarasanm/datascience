...
# payment_plan, initial_list_status - same for all obs
...
colnames(loan_filtered) <- c('id', 'member_id', 'loan_amount', 'funded_amount', 'funded_amount_investor', 'payment_term',
                    ...
                    'policy_code', 'application_type', 'acc_now_delinq', 'chargeoff_within_12_months',
                    'delinq_amount', 'no_of_public_bankruptics', 'tax_lines', 'emp_length_rounded')
